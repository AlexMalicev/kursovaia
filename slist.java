...
public class slist {
    public JPanel createContentPane (){
        ...
        ActionListener actionListener = new form_ist_sloj_l();
        ...
        ActionListener ParceListener = new form_ist_sloj_sr();
        ...
        ActionListener CListener  = new form_ist_sloj_sl();
        ...
        JButton v3 = new JButton("Математика");
        v3.setLocation(20, 70);
        v3.setSize(120,20 );
        v3.setBackground(Color.YELLOW);
        ActionListener actionListener2 = new formsl();
