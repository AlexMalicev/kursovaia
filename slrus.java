...
public class slrus {
    public JPanel createContentPane (){
        ...
        ActionListener actionListener = new form_rus_sloj_l();
        ...
        ActionListener ParceListener = new form_rus_sloj_sr();
        ...
        ActionListener CListener  = new form_rus_sloj_sl();
        ist.addActionListener(CListener);
        totalGUI.add(ist);
        
        
        JButton v1 = new JButton("Математика");
        v1.setLocation(10, 10);
        v1.setSize(150,20 );
        v1.setBackground(Color.YELLOW);
        ActionListener actionListener1234 = new formsl();
