...
public class knop_mat_sl_var_vopr {
    public JPanel createContentPane (){

        JPanel totalGUI = new JPanel();
        totalGUI.setLayout(null);

        JLabel Label = new JLabel("(9*(4/10))/((4*(1/10))+(5*(3/10)))= ...");
        Label.setLocation(10, 50);
        Label.setSize(1250, 50);
        Label.setForeground(Color.blue);
        totalGUI.add(Label);
        
        JLabel Label2 = new JLabel("Какое из этих чисел иррационально?");
        Label2.setLocation(10, 165);
        Label2.setSize(1250, 50);
        Label2.setForeground(Color.blue);
        totalGUI.add(Label2);
        
        JLabel Label3 = new JLabel("Какой угол образует часовая стрелка в 16:00?");
        Label3.setLocation(10, 270);
        Label3.setSize(1250, 50);
        Label3.setForeground(Color.blue);
        totalGUI.add(Label3);
        
        JLabel Label4 = new JLabel("27*((2/3)-(1/18)-(1/6))= ...");
        Label4.setLocation(10, 380);
        Label4.setSize(1250, 50);
        Label4.setForeground(Color.blue);
        totalGUI.add(Label4);
        
        JLabel Label5 = new JLabel("Пятизначное число кратное 35, сумма цифр =3");
        ...
        JButton v21 = new JButton("sqrt (35)");
        ...
        JButton v22 = new JButton("sqr (25)");
        ...
        JButton v23 = new JButton("sqrt (25)");
        ...
        JButton v24 = new JButton("sqr (35)");
        ...
        ActionListener actionListener1234 = new form_mat_sloj_sr();
