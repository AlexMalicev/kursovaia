...
public class knop_mat_l_var_vopr {
    public JPanel createContentPane (){

        JPanel totalGUI = new JPanel();
        totalGUI.setLayout(null);

        JLabel Label = new JLabel("8-это ...");
        Label.setLocation(10, 50);
        Label.setSize(1250, 50);
        Label.setForeground(Color.blue);
        totalGUI.add(Label);
        
        JLabel Label2 = new JLabel("Сравнить выражения: 5-2...2+1");
        Label2.setLocation(10, 165);
        Label2.setSize(1250, 50);
        Label2.setForeground(Color.blue);
        totalGUI.add(Label2);
        
        JLabel Label3 = new JLabel("Вставьте пропущенное число: ...-1=5");
        Label3.setLocation(10, 270);
        Label3.setSize(1250, 50);
        Label3.setForeground(Color.blue);
        totalGUI.add(Label3);
        
        JLabel Label4 = new JLabel("Вставьте пропущенное число: 1+...=7");
        Label4.setLocation(10, 380);
        Label4.setSize(1250, 50);
        Label4.setForeground(Color.blue);
        totalGUI.add(Label4);
        
        JLabel Label5 = new JLabel("Выражение верное для <<9 увеличить на 7>>");
        ...
        JButton v53 = new JButton("9+7=15");
        ...
        JButton v54 = new JButton("9+7=16");
        ...
        ActionListener actionListener1234 = new form_mat_sloj_l();
