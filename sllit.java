...
public class sllit {
    public JPanel createContentPane (){
        ...
        ActionListener actionListener = new form_lit_sloj_l();
        ...
        ActionListener ParceListener = new form_lit_sloj_sr();
        ...
        ActionListener CListener  = new form_lit_sloj_sl();
        ...
        JButton v2 = new JButton("Математика");
        v2.setLocation(20, 40);
        v2.setSize(120,20 );
        v2.setBackground(Color.YELLOW);
        ActionListener actionListener1 = new formsl();
